<?php
	...
	if (isset($_SESSION['formAmount'])) unset($_SESSION['formAmount']);
	if (isset($_SESSION['formDate'])) unset($_SESSION['formDate']);
	if (isset($_SESSION['formCategory'])) unset($_SESSION['formCategory']);
	if (isset($_SESSION['formComment'])) unset($_SESSION['formComment']);
